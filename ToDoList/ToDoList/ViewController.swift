...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //3c
        tableData = getItems()
        // access core data, this line of code should come before tableView.reloadData() ============================== ****************
...
extension ViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    //what do I do when I'm clicked?! check mark
...
//3b -> after jump to CORE DATA FUNC
        ...
        //activates sorting by having this line here
        tableData = getItems()
